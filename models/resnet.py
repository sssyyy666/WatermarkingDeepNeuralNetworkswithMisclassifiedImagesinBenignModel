...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, drop_prob=0.0, block_size=7):
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, drop_prob=0.0, block_size=7):
    ...
    def _make_layer(self, block, planes, num_blocks, stride, drop_prob, block_size):
        ...
        for stride in strides:
            layers.append(block(self.in_planes, planes, stride, drop_prob, block_size))
...
def ResNet18(drop_prob=0.1, block_size=7):
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=10, drop_prob=drop_prob, block_size=block_size)
def ResNet34():
