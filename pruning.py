...
def get_params_to_prune(arch, net):
    ...
    if arch == "vgg16":
        return (
            ...
            (net.features[8], 'weight'),
            (net.features[10], 'weight'),
            (net.features[11], 'weight'),
            ...
            (net.features[27], 'weight'),
            (net.features[28], 'weight'),
            (net.features[30], 'weight'),
            (net.features[31], 'weight'),
            (net.features[34], 'weight'),
            (net.features[35], 'weight'),
            (net.features[37], 'weight'),
            (net.features[38], 'weight'),
            (net.features[40], 'weight'),
            (net.features[41], 'weight'),
            #(net.features[30], 'weight'),
            #(net.features[32], 'weight'),
          #  (net.features[34], 'weight')
        )
